%\VignetteIndexEntry{oosp2_Introduction_to_Environments_and_Enhanced_Environment-Based_Objects}
...
\mtitleb {Object Oriented Statistical Programming (oosp 0.3.1)}{Environment-Based Programming (Draft)}
